...
import pink.utils.Gains;

/** Add your docs here. */
public class PinkTalon extends TalonFX {
  private TalonFXConfiguration config = new TalonFXConfiguration();
  private int id;
  private int unit = 360;

  // the base value is 26120, 26220
  private int fullRot = 26120;
   ...
   * @param _neutralMode
   */
  public PinkTalon(int _id, TalonFXInvertType _invert, NeutralMode _neutralMode) {
    super(_id);
  ...
  public void setPosition(double _position) {
    double targetPositionRotations = _position * (fullRot / unit); // this resolves to 72.5 ticks per degree
  ...
  public int GetFullRot() {
    return this.fullRot;
  }

  public int setFullRotation(int _fullRot) {
    this.fullRot = _fullRot;
